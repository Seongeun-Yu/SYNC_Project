		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "B2C Order List",
									"targetURL": "#cl3syncyoungsdb2cb2corder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl3syncyoungsdb2cb2corder-display": {
								"semanticObject": "cl3syncyoungsdb2cb2corder",
								"action": "display",
								"description": "B2C Order List",
								"title": "B2C Order List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl3.syncyoung.sd.b2c.b2corder",
									"url": sap.ui.require.toUrl("cl3/syncyoung/sd/b2c/b2corder")
								}
							}
						}
					}
