		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#cl3syncyoungsdsaleschartsaleschart-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl3syncyoungsdsaleschartsaleschart-display": {
								"semanticObject": "cl3syncyoungsdsaleschartsaleschart",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl3.syncyoung.sd.saleschart.saleschart",
									"url": sap.ui.require.toUrl("cl3/syncyoung/sd/saleschart/saleschart")
								}
							}
						}
					}
